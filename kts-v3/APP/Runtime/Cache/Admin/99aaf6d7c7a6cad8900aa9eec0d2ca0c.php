...
<script type="text/javascript">
    ...
    var search_url="<?php echo U('Admin/Book/categoryList');?>";
    function search(){
...
<ol class="breadcrumb">
    ...
    <li>栏目设置</li>
    <li class="active"><a href="<?php echo U('Admin/Book/categoryList');?>">栏目类型管理</a></li>
</ol>
<ul id="myTab" class="nav nav-tabs">
    <li class="active"><a href="javascript:void(0);">栏目管理</a></li>
    <li><a href="<?php echo U('Admin/Book/categoryAdd');?>">添加栏目类型</a></li>
</ul>
            ...
            <label class="input-group-addon" for="groupType">列表：</label>
                <div class="input-group-btn">
                    <select name="father_id" id="father_id" class="form-control" data-live-search="false">
                        ...
                        <?php if(is_array($typeList)): $i = 0; $__LIST__ = $typeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["cg_id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
        </div>
        <div class="input-group">
    ...
    <table class="table table-striped table-hover">
        ...
        <tbody>
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i;?><tr> 
                ...
                <td>
                 <p> 共<span style="color:red;"><?php echo ($s["level"]); ?></span>级 </p> 
                </td>
                <td><?php echo ($s["introduce"]); ?></td>
                <td>
                    <div class="btn-group">
                        <a class="btn btn-warning" href="<?php echo U('Admin/Book/categoryEdit?cg_id='.$s['cg_id']);?>">修改</a>
                    </div>
                </td>
