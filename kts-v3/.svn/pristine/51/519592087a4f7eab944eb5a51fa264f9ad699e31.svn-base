...
//必填，不能修改
//服务器异步通知页面路径
$alipay_config['notify_url'] = C('WEB_PATH').'/index.php/Order/Payment/BookAlipayNotify';
//需http://格式的完整路径，不能加?id=123这类自定义参数

//页面跳转同步通知页面路径
$alipay_config['return_url'] = C('WEB_PATH').'/index.php/Order/Payment/BookAlipayNotify';
