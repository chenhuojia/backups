...
<ol class="breadcrumb">
    ...
    <li>小组设置</li>
    <li class="active"><a href="<?php echo U('Admin/Topic/tagList');?>"> 话题栏目列表</a></li>
    <li>添加话题栏目</li>
</ol>
<form class="form-horizontal" action="<?php echo U('Admin/Topic/tagAdd');?>" method="post">
    <div class="form-group">
        <label for="name" class="col-sm-2 control-label">话题：</label>
        <div class="col-sm-8">
            <!-- <input type="hidden" name="groups_id" class="form-control" id="groups_id" value="<?php echo ($classType["groups_id"]); ?>" /> -->
