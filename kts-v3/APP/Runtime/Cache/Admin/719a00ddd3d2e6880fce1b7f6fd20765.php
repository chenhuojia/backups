...
<ol class="breadcrumb">
    ...
    <li>信息管理</li>
     <li class="active"><a href="<?php echo U('Admin/Information/bannerList');?>">banner管理</a></li>
    <li>添加banner</li>
</ol>  
<ul id="myTab" class="nav nav-tabs">
    <li class="active"><a href="javascript:void(0);">添加banner</a></li>
</ul>
<form action="<?php echo U('Admin/Information/bannerAdd');?>" class="form-horizontal" method="post" enctype="multipart/form-data">
    <div class="form-group">
        <label for="banners_name" class="col-sm-2 control-label">标题</label>
        <div class="col-sm-10">
            <input class="form-control" type="text" id="title"   autocomplete="off" value="" name="title" datatype="s" nullmsg="标题名称" errormsg="标题名称"/>
            <div class="Validform_checktip">请输入标题</div>
        </div>
    </div>
    <div class="form-group">
        <label for="banners_name" class="col-sm-2 control-label">跳转地址</label>
        <div class="col-sm-10">
            <input class="form-control" type="text" id="url" autocomplete="off" value="" name="url" />
          
        </div>
    </div>
    <div class="form-group">
        <label for="banners_name" class="col-sm-2 control-label">描述</label>
        <div class="col-sm-10">
            <input class="form-control" type="text" id="desc" autocomplete="off" value="" name="desc" />
        </div>
    </div>
     <div class="form-group">
        <label for="imageurl" class="col-sm-2 control-label">图标</label>
        <div class="col-sm-10">
             <input class="form-control" type="file" id="imageurl" name="imageurl"  />
             <input type="hidden" name="imageurl1" value=""  />
