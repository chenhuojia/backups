...
<div class="container">
    <form class="form-signin" action="<?php echo U('Admin/User/Login');?>" method="post">
       ...
       <!--  <div class="captcha" >  
          <input name="verify"  class="captcha-text" placeholder="验证码" type="text" style="height:40px;margin-bottom:6px;" required>                  
          <img id="verifyImg"  alt="验证码" src="<?php echo U('Admin/User/verify');?>" style="height:40px;margin-bottom:6px;" title="点击刷新" onClick="this.src=this.src+'&co'+Math.random()"/> 
        </div>   -->
