            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post"  action="<?php echo U('Admin/Blog/edit2',array('art_id'=>$data['art_id']));?>" class="form-horizontal">                           
                            <div class="form-group">
                                <label class="col-sm-2 control-label">标题</label>

                                <div class="col-sm-10">
                                    <input type="text" placeholder="请输入标题" class="form-control" name="title" value="<?php echo ($data['title']); ?>">
                                ...
                                <div class="col-sm-10">
                                    <div class="col-sm-4 m-l-n">
                                        <select class="form-control" name="cate_id">
                                        	<?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if(($v['cate_id']) == $data['cate_id']): ?><option value="<?php echo ($v["cate_id"]); ?>" selected><?php echo ($v["name"]); ?> // <?php echo ($v["english"]); ?></option>
                                        		<?php else: ?>
                                        			<option value="<?php echo ($v["cate_id"]); ?>"><?php echo ($v["name"]); ?> // <?php echo ($v["english"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                            ...
                            <div class="form-group has-success">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="introduction" value="<?php echo ($data['introduction']); ?>">
...
$(function(){
    ...
    $('.submit').click(function(){
       //验证标题
       if($('input[name="title"]').val().length >= 3 && $('input[name="title"]').val().length <=50 && $('input[name="title"]').val()!=''){ 
    	   $('input[name="title"]').next().css({'display':'none'});
           ok1=true;
       }else{
    	   $('input[name="title"]').next().css({'display':'block'});
       }        
       //验证分类
       ...
       if($('input[name="introduction"]').val()!=''){
    	   $('input[name="introduction"]').next().css({'display':'none'});
           ok3=true;
       }else{
    	   $('input[name="introduction"]').next().css({'display':'block'});
       } 
