...
class StatisticClient
{
    ...
    public static function report( $module, $interface,int $success, $code, $msg, $report_address = '')
    {
        $report_address = $report_address ? $report_address : 'udp://192.168.1.163:55656';
