...
<ol class="breadcrumb">
    ...
    <li>积分管理</li>
    <li><a href="<?php echo U('Admin/Integral/integralList');?>"> 积分列表</a></li>
...
<ul id="myTab" class="nav nav-tabs">
    ...
    <form action="" class="form-horizontal" method="post">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input class="form-control" type="text" value="" name="source" id="user_name" />               
            </div>
        </div> 
        <div class="form-group">
            <label for="remark" class="col-sm-2 control-label">积分数额</label>
            <div class="col-sm-10">
                <input class="form-control" type="text" value="" id="remark" name="number"  />
