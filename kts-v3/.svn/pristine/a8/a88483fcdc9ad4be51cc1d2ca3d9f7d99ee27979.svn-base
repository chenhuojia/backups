...
<script type="text/javascript">
    var search_url="<?php echo U('Admin/Groups/groupsList');?>";
    function search(){
...
<ol class="breadcrumb">
    ...
    <li>关注设置</li>
    <li class="active"><a href="<?php echo U('Admin/Groups/groupsList');?>">关注管理</a></li>
</ol>
<ul id="myTab" class="nav nav-tabs">
    <li class="active"><a href="javascript:void(0);">关注管理</a></li>
    <li><a href="<?php echo U('Admin/Groups/groupsAdd');?>">添加关注</a></li>
</ul>
<div class="tab-content">
    <div class="form-inline" role="form">
        <div class="input-group">
            <input type="text" id="className" name="className" placeholder="关注名称" value="" class="form-control"/>
...
<div class="table-responsive">
    <table class="table table-striped table-hover">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><?php echo (mb_substr($s["introduce"],0,15,'utf-8')); ?></td>
                <td><?php echo ($s["follow_number"]); ?></td>
                <td>
                    <div class="btn-group">
                        <a class="btn btn-warning" href="<?php echo U('Admin/Groups/groupsDet?group_id='.$s['group_id']);?>">详情</a>    

                      <!--   <a class="btn btn-danger" href="javascript:showYesOrNo('确定要删除吗？','<?php echo U('Admin/Groups/groupsDel?group_id='.$s['group_id']);?>')">删除</a> -->
                    </div>
                </td>
