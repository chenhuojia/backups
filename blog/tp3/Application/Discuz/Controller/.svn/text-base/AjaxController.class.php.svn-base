     ...
     **/
     ...
     public function discuss(){
        ...
        if ($data){                    
            if ($user_id){
                if ($discuss_id){
                    $result=$discuss->add(array('art_id'=>$art_id,'art_title'=>$data['title'],'reply_id'=>$data['user_id'],'user_id'=>$user_id,'parent_id'=>$discuss_id,'content'=>$content,'addtime'=>$time));                
                }else{
                ...
                if ($discuss_id){
                    $result=$discuss->add(array('art_id'=>$art_id,'art_title'=>$data['title'],'reply_id'=>$data['user_id'],'user_id'=>0,'parent_id'=>$discuss_id,'content'=>$content,'addtime'=>$time));
                }else{
